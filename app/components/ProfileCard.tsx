            ...
            >
                <div className='col-span-2 flex flex-col gap-y-3 items-center border-r py-6'>
                    ...
                    <div className='flex flex-col gap-y-3'>
                        <div className='flex gap-x-3 items-center'>
                            ...
                            <div>
                                <p className='text-[12px] lg:text-[14px] text-[rgba(0,0,0,0.5)]'>Member since</p>
                                <p className='font-medium text-[14px] lg:text-[16px]'>{new Date(user.memberSince).toLocaleDateString()}</p>
                            </div>
                        </div>
                        <div className='flex gap-x-3 items-center'>
                            <div className='size-9 bg-[#CFFDE7] flex items-center justify-center rounded-[10px]'>
                            ...
                            <div>
                                <p className='text-[12px] lg:text-[14px] text-[rgba(0,0,0,0.5)]'>Account type</p>
                                <p className='font-medium text-[14px] lg:text-[16px]'>{user.accountType}</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div className='col-span-4 p-6 flex flex-col gap-y-4'>
                    <div className='flex justify-between items-center'>
                        <h2 className='font-bold text-[20px] lg:text-[24px]'>Profile Details</h2>
                        <button
                            onClick={() => setIsOpen(false)}
