            ...
            <div className="col-span-3 flex flex-col gap-y-8">
              ...
              <div>
                ...
                <div className="flex space-x-4 justify-start mb-5">
                  <NativeSelect
                    className="h-12 w-35 rounded-lg bg-white shadow-md/20 text-gray-800 font-inter text-lg hover:bg-gray-100 focus:outline-none cursor-pointer"
                    value={currentMonth}
                  ...
                  <div className="grid grid-cols-7 gap-y-3 xl:gap-x-4 2xl:gap-x-9 text-center px-4">
                    {days.map((item, i) => (
                      <div key={i} className="flex items-center justify-center">
                        <div
                          onClick={() =>
                            item.type === "current" && setSelectedDate(item.day)
                          }
        ...
        <div className="space-y-4 p-5">
          ...
          <div className="flex flex-col gap-y-2">
            ...
            <div className="">
              ...
              <div className="flex space-x-4 justify-start mb-5">
                <NativeSelect
                  className="h-12 w-35 rounded-lg bg-white shadow-md/20 text-gray-800 font-inter text-lg hover:bg-gray-100 focus:outline-none"
                  value={currentMonth}
                  onChange={handleMonthChange}
                >
                  {monthNames.map((month, i) => (
